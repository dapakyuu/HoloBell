...
<head>
  ...
  <link rel="stylesheet" href="oshi.css">
...
<body>
        ...
        <ul class="navbar-nav mb-2 mb-lg-0 ms-auto">
          ...
          <li class="nav-item">
            <?php if(isset($_SESSION["is_login"]) && $_SESSION["is_login"] == true) { ?>
                <form action="oshi.php" method="POST">
  ...
  <br> </br>
  <h1 class="text-center">My Oshi</h1>
  <br> </br>
  <div class="text-center">
    <?php $oshiImage = str_replace(' ', '', $_SESSION['oshi']) . '.png'; ?>
    <img src="./oshi/<?= $oshiImage; ?>" class="img-fluid w-25 h-25" alt="Oshi Logo">
  </div>
  <div class="container-fluid">
                ...
                <br> </br>
                        <div class="row">
                            <?php 
                                ...
                                if ($live['channel']['org'] == "Hololive" && $live['channel']['english_name'] == $myOshi && ($live['status'] == "live" || $live['status'] == "upcoming")) {
                                $no_live = false;
                            ?>
  ...
  <script>
        ...
        <?php if (isset($oshi_null) && $oshi_null == true) { ?>
            Swal.fire({
                title: "Akses Gagal!",
