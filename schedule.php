...
<body>
  ...
  <br> </br>
  <h1 class="text-center">Hololive Members Schedule</h1>
  <br> </br>
  <div class="container-fluid">
  ...
  <br> </br>
        <div class="row">
            <?php foreach($data as $live): 
                if($live['channel']['org'] == "Hololive" && $live['status'] == "live") {
                  $no_live_now = false;
              ?>
  ...
  <br> </br>
        <div class="row">
            <?php foreach($data as $live): 
                ...
                if($live['channel']['org'] == "Hololive" && $live['status'] == "upcoming" && $hariIni == $curDate) {
                  $no_live_today = false;
              ?>
                <div class="col-md-3 d-flex justify-content-center">
                    <div class="card" style="width: 18rem;">
